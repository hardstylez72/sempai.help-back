...
router.put('/', async (req, res) => {
    try {
        if (_.has(req, 'body.data.descr') && _.has(req, 'body.data.url') && _.has(req, 'body.data.abstract') && _.has(req, 'body.data.user')) {
...
router.post('/', async (req, res) => {
    try {
        if (_.has(req, 'body.data.amount') && _.has(req, 'body.data.offset')) {
